...
- Trollagem, comentários insultuosos ou depreciativos, ataques pessoais ou políticos
- Assédio público ou privado
- Publicar informações privadas de terceiros (endereço físico, e-mail) sem permissão
- Outras condutas razoavelmente consideradas inadequadas em ambiente profissional

## Aplicação

Casos de abuso podem ser reportados ao mantenedor responsável via [Security Advisory privado](https://github.com/Paulo-Marcos-Lucio/pix-nfc-reference/security/advisories/new) ou e-mail listado no perfil do GitHub.

Todas as reclamações serão revisadas e investigadas com rapidez e justiça. Detalhes do incidente são tratados com confidencialidade.

## Atribuição

Adaptado do [Contributor Covenant](https://www.contributor-covenant.org), versão 2.1, disponível em https://www.contributor-covenant.org/version/2/1/code_of_conduct.html.
